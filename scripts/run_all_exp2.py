"""Batch runner for Experiment 2: Transformer and iTransformer."""
...
def main() -> None:
    runs = [
        ("configs/exp2a_vanilla_transformer.yaml", "exp2_standard"),
        ("configs/exp2b_itransformer.yaml", "exp2_standard"),
    ]
